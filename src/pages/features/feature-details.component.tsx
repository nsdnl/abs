          ...
          content: [
            {
              ...
              style: {height: '500px'},
              badge: false,
              descriptionDt: `Trimester 1: omvat gerichte cardio- en aangepaste krachttraining gericht op de belangrijkste spiergroepen. Voorbereidingsoefeningen om de bevalling te vergemakkelijken en tegelijkertijd aan het lichaamsbewustzijn te werken. Trimester 2: Met een verhoging van het energieniveau willen we de drang om te trainen tot uitputting vermijden. De focus zal liggen op meer variatie, stabiliteit en kracht  met de nadruk op de binnenkant van de dijen en bilspieren. Trimester 3: Terwijl uw lichaam zich voorbereidt op de bevalling, zult u merken dat u langzamer wordt. We zullen deze tijd gebruiken om ons te concentreren op cardiovasculaire oefeningen, mobiliteit om de buikkracht te behouden.`,
